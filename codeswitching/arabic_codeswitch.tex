...
\address{ $^1$ CLSP, Johns Hopkins University; $^2$CIS, University of Pennsylvania  \\ 
              Baltimore, MD, USA; Philadelphia, PA, USA \\
...
available for all languages, for instance in Algerian vernacular
...
knowledge. Such a resource is necessary as romanized Arabic is
...
utterance \cite{bullock2009cambridge}.  It can be viewed as a
sociolinguistic phenomenon where situation and topic influence the
choice of language \cite{kachru1977linguistic}. At this point it is
...
for parsing mixed sentences. More recently,
...
more users employ computer-mediated communication. More information
...
We used a corpus that is crawled from an Algerian newspaper
website. We scraped 598047 pages in September 2012. These fora are
rich, not only in dialectal Arabic content, but also in French. The
...
events.  We extracted 6949 comments, containing 150k words in
...
Mechanical Turk.  %(TODO Cotterell 2014).
...
final data set contains 339504 annotated comments with an average
length of 19 tokens, as determined by separating on white space and
punctuation. Our corpus has 493038 types and 6718502 tokens, and is
formatted in JSON.
